...
getComputedDataSWS <- function(reporter = NA, omit = FALSE) {
  ...
  if (file.exists(f)) {
    ...
    d_old <-
      data.table(
        # geographicAreaM49     = character(), # commented 23/03/2025 because not working
        geographicAreaM49Reporter     = character(), # added 23/03/2025
        geographicAreaM49Partner     = character(), # added 23/03/2025
