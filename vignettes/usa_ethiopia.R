...
joined %>% filter(fcl == fcl_to_test)
tldata_old %>% filter(reporter == reporters, year == year, fcl == fcl_to_test, flow == flow_to_test)
tldata %>% filter(reporter == reporters, year == year, fcl == fcl_to_test, flow == flow_to_test)
tradedata %>% filter(reporter == reporters, year == year, fcl == fcl_to_test, flow == flow_to_test)
adjustments %>% filter(reporter == reporters, fcl == fcl_to_test)
